...
<body>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" data-wrap="false" data-interval="8000" data-pause="false">
      ...
      <div class="item active">
        <div id="slide1-wm" class="wm-slide">
          <ul id="slide1-wm-tiles" class="wm-slide-tiles">
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/01.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/08.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/04.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/06.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/16.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/13.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/07.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/09.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/10.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/12.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/05.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/14.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/02.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/15.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/03.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/17.jpg" class="lazy"></li>
          </ul>
        </div>
        <div class="container">
      ...
      <div class="item">
        <div id="slide2-wm" class="wm-slide">
          <ul id="slide2-wm-tiles" class="wm-slide-tiles">
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/cupcake/01.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/cupcake/04.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/16.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/13.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/07.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/09.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/cupcake/06.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/10.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/12.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/cupcake/05.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/14.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/cupcake/02.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/08.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/15.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/cupcake/03.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/17.jpg" class="lazy"></li>
          </ul>
        </div>
        <div class="container">
      ...
      <div class="item">
        ...
        <div id="slide3-wm" class="wm-slide">
          <ul id="slide3-wm-tiles" class="wm-slide-tiles">
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/05.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/01.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/08.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/04.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/06.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/16.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/13.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/07.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/09.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/10.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/12.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/05.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/14.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/02.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/15.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/other/03.jpg" class="lazy"></li>
            <li><img data-src="//www.<?php echo $siteUrl; ?>/img/gallery/celebration/17.jpg" class="lazy"></li>
          </ul>
        </div>
        <div class="container">
